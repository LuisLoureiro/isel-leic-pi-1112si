...
namespace HttpServer
{
    public class Program
    {
        ...
        {
            List<CurricularUnit> listUCs = new List<CurricularUnit>();

            CurricularUnit ave = new CurricularUnit("Ambientes Virtuais de Execução", "AVE", true, (0x01 << 4), 6);
            ave.Objectives = "Conhecer os requisitos e o funcionamento dos ambientes virtuais de execução. " +
                "Saber desenvolver aplicações para ambientes virtuais de execução.";
            ave.Results = "Os estudantes que terminam com sucesso esta unidade curricular serão capazes de: \n" +
            ...
            ave.Assessment = "Os resultados da aprendizagem (1) e (3) são avaliados através do teste escrito. " +
            ...
            ave.Program = "Problemas do código não controlado no que respeita a: robustez, interoperabilidade, portabilidade " +
            ...
            CurricularUnit rcp = new CurricularUnit("Redes de Computadores", "RCp", true, (0x01<<4), 6);
            rcp.Objectives = "A disciplina tem como objectivo dotar os alunos com os conhecimentos base na área de redes " +
            ...
            rcp.Results = "Os estudantes que terminam com sucesso esta unidade curricular serão capazes de:\n" +
            ...
            rcp.Assessment = "Os resultados de aprendizagem são avaliados individualmente através de testes escritos e de " +
            ...
            rcp.Program = "Comunicações digitais. Modelo OSI. Comunicação ponto a ponto e multiponto. Redes de comunicação "+
            ...
            CurricularUnit pi = new CurricularUnit("Programação na Internet", "PI", true, (0x01 << 5), 6);
            pi.Objectives = "Esta unidade curricular representa um dos pontos de consolidação e interligação de diversos temas " +
            ...
            pi.Results = "Os estudantes que terminam com sucesso esta unidade curricular serão capazes de:\n" +
            ...
            pi.Assessment = "Os resultados da aprendizagem (1), (2), (3) e (4) são avaliados individualmente através de teste escrito." +
            ...
            pi.Program = "A arquitectura da World Wide Web. Identificação de recursos, sintaxe e semântica de URLs. " +
            ...
            pi.AddPrecedence(ave); pi.AddPrecedence(rcp);
